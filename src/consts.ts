...
export const SITE_DESCRIPTION = 'Welcome to my homepage. Im the Administrator the Veltron Network, and an aspiring content creator, a cybersecurity geek, and a Linux nerd.'
